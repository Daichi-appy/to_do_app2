...
export default {
    ...
    methods: {
        ...
        moveFinishedTask: function(task_id) {
            ...
            //もろもろスタイルなどを足して完了済みに追加
            el_clone.getElementByTagName('input')[0].checked = 'checked';
            el_clone.getElementByTagName('label')[0].classList.add('line-through');
            el_clone.getElementByTagName('label')[0].classList.remove('word-color-black');
            var li = document.querySelector('#finished-tasks > ul').insertBefore(el_clone, li);
